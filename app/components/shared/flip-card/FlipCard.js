  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-center gap-1">
        ...
        >
          <div
            className={`relative h-full w-full transition-transform duration-700 ease-in-out [transform-style:preserve-3d] ${isFlipped ? "[transform:rotateY(0deg)]" : "[transform:rotateY(180deg)]"} `}
          >
            {/* Front Side */}
            <div className="absolute flex h-full w-full flex-col items-center justify-between overflow-hidden rounded-[60px] bg-[#1e1e1e] p-6 text-center font-sans text-[#d5cbcb] [transform:rotateY(180deg)] [backface-visibility:hidden] [box-shadow:inset_-29px_15px_17px_rgba(111,109,109,0.956),inset_-29px_15px_17px_rgba(34,34,34,0.697),0px_10px_20px_rgb(0,0,0),inset_15px_-18px_19px_rgb(0,0,0)]">
              {/* Logo Circle */}
              <div
            ...
            {/* Back Side */}
            <div className="absolute flex h-full w-full flex-col items-center justify-between overflow-hidden rounded-[60px] bg-[#1e1e1e] p-6 text-center font-sans text-[#d5cbcb] [backface-visibility:hidden] [box-shadow:inset_-29px_15px_17px_rgba(111,109,109,0.956),inset_-29px_15px_17px_rgba(34,34,34,0.697),0px_10px_20px_rgb(0,0,0),inset_15px_-18px_19px_rgb(0,0,0)]">
              {/* Logo Circle */}
              <div
                className="h-[45%] w-4/5 rounded-full border border-[#1a191923] bg-cover bg-center bg-no-repeat [box-shadow:-5px_-9px_5px_rgba(255,255,255,0.16),-5px_-9px_5px_rgba(34,34,34,0.697),3px_8px_4px_rgba(0,0,0,0.392)] max-md:h-[40%] max-md:w-[70%] max-[399px]:h-[35%] max-[399px]:w-[65%]"
